...
void execution( int internet_socket )
{
	...
	printf("Geef het aantal te verzenden pakketten in:");
	scanf("%d", &AantalBytes);

	FILE *fp;
	fp = fopen("C:\\Users\\natha\\Documents\\School\\2de Semester\\Netwerken\\opdracht\\code\\UDP\\Ontvangen_Stream.csv", "w+");
	...
	fprintf(fp, "%d Ontvangen pakketten: \n", PakketenOntvangen);
	fprintf(fp, "%f Tijd tussen eerste en laatste pakket: \n", verschil);
	fclose(fp);
	//Step 2.2

...
void execution( int internet_socket )
{
	...
	FILE *fp;
	fp = fopen("C:\\Users\\natha\\Documents\\School\\Netwerken_Opdracht\\code\\UDP\\Ontvangen_Stream.csv", "w+");
	...
	fprintf(fp, "%d pakketten ontvangen \n", PakketenOntvangen);
	fprintf(fp, "%f seconden tussen het eerste en laatste pakket. \n", verschil);
	fprintf(fp, "%f / %d\n", PacketlossByTimeout, AantalBytes);
	fprintf(fp, "Er is %.8f%% packetloss.\n", PacketLoss_Totaal);
	fclose(fp);
	//Step 2.2
